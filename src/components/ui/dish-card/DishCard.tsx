  ...
  return (
    <div className='group relative flex w-full flex-col items-center gap-2.5 px-6 pb-4.5 pt-0'>
      ...
      <div className='z-20 flex h-full flex-col gap-2'>
        <p className='max-w-36 min-h-[36.4px] text-center text-body-base-medium text-white'>
      ...
      <div className='absolute bottom-0 left-0 z-10 h-[85%] w-full rounded-2xl bg-base-dark-bg-2 transition-all duration-150 group-hover:bg-base-dark-bg-2-hover' />
    </div>
  );
};
