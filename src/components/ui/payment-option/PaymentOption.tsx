...
export const PaymentOption: React.FC<PaymentOptionProps> = ({
  ...
  return (
    <div
      ...
      data-active={active}
      onClick={onClick}
      className='group relative flex h-16 w-[101px] flex-col items-center justify-center gap-[2px] rounded-lg border border-base-dark-line bg-base-dark-bg-2 hover:bg-base-dark-bg-1'>
      {typeMap[type].icon}
      {active && (
